...
TEXT([PLAIN('\n'), SET([ATOM('a'), ATOM('b'), ATOM('c')], LIST([APPLY(VAR([], ATOM('e')), [], []), STR("'hi!'"), APPLY(VAR([], ATOM('q')), [VAR([], ATOM('u'))], [])])), APPLY(VAR([], ATOM('_123')), [], []), REMARK('/**/'), SET([ATOM('a')], INT(10L)), PLAIN(' '), REMARK('// q...'), PLAIN('\n'), COMMENT(), PLAIN('\n')], 0, 0),
...
TEXT([PLAIN('\n'), REMARK('/*  Hello world! */'), PLAIN('\nint main()\n{\n    '), REMARK('// Entry point...'), PLAIN('\n    printf( '), STR('"Hello world!"'), PLAIN(' );\n\n    return 1;\n}\n')], 0, 0),
...
#   ---- 05 -- LATE_BOUNDED (variable argument lists)
0,
...
11; 10; 9;
{1} {2} {3} {4} {5} {6} {7} {8} {9} {0} {q} {w} {r} {t} {y} {u} {i} {o} {p} {s} {d} {f} {g} {h} {j}
{q} (3) {u} (4) {d} (5) {w} (8) {i} (9) {f} (0) {r} (r) {o} (t) {g} (y)
25
106164
"""
),(
...
#   ---- eval
                ...
                if isinstance( plain, str ):
                    plain = trim_tailing_whitespace( plain )
                    msg = plain
                else:
                    msg = repr( plain )
                print msg, '\n'
