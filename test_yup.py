...
TEXT([PLAIN('\n'), SET([ATOM('a'), ATOM('b'), ATOM('c')], LIST([APPLY(VAR([], ATOM('e')), [], []), STR("'hi!'"), APPLY(VAR([], ATOM('q')), [VAR([], ATOM('u'))], [])])), APPLY(VAR([], ATOM('_123')), [], []), PLAIN('/**/'), SET(ATOM('a'), INT(10)), PLAIN(' // q...\n'), COMMENT(), PLAIN('\n')], 0, 0),
...
TEXT([PLAIN('\n'), APPLY(LAMBDA([([], ATOM('p'), None), ([ATOM('pp1'), ATOM('pp2')], ATOM('pp'), VAR([], ATOM('abc'))), ([], ATOM('...'), None), ([ATOM('ppp1')], ATOM('ppp'), None), ([], ATOM('pppp'), None)], APPLY(VAR([], ATOM('f')), [VAR([], ATOM('p1'))], [])), [EMBED(LIST([INT(1), VAR([], ATOM('a')), VAR([], ATOM('b'))]))], []), PLAIN('\n'), SET(ATOM('lst'), LIST([VAR([], ATOM('pa')), VAR([], ATOM('pb')), VAR([], ATOM('pc'))])), PLAIN('\n'), APPLY(LAMBDA(VAR([], ATOM('lst')), APPLY(VAR([], ATOM('f2')), [], [])), [], []), PLAIN('\n')], 0, 0),
...
r"""
($l (-0.123 -48 0o77 "\\Hello \"world\"!\n" 3.14e-29 0xFF1 *a *() ($b) '\x000' '\'' '\n' \c.(d)))
""",

TEXT([PLAIN('\n'), APPLY(VAR([], ATOM('l')), [LIST([FLOAT(-0.123), INT(-48), INT(63), STR('"\\\\Hello \\"world\\"!\\n"'), FLOAT(3.14e-29), INT(4081), EMBED(VAR([], ATOM('a'))), EMBED(LIST([])), APPLY(VAR([], ATOM('b')), [], []), STR("'\\x000'"), STR("'\\''"), STR("'\\n'"), LAMBDA([([], ATOM('c'), None)], LIST([VAR([], ATOM('d'))]))])], []), PLAIN('\n')], 0, 0),
...
TEXT([PLAIN('\n'), APPLY(VAR([], ATOM('f')), [COND(VAR([], ATOM('c')), INT(1), INT(2)), COND(LIST([INT(2)]), APPLY(VAR([], ATOM('e')), [], []), None), COND(APPLY(VAR([], ATOM('f')), [], []), VAR([], ATOM('d')), COND(INT(1), VAR([], ATOM('dd')), COND(STR("'2'"), VAR([], ATOM('ddd')), VAR([], ATOM('dddd')))))], []), PLAIN('\n')], 0, 0),
...
TEXT([PLAIN('\n'), APPLY(VAR([], ATOM('print')), [TEXT([APPLY(VAR([], ATOM('e')), [], []), PLAIN(' 100.0 '), APPLY(VAR([], ATOM('len')), [STR('"We all live in a yellow submarine,"')], []), PLAIN('\n')], 0, 0)], []), PLAIN('\n'), APPLY(VAR([], ATOM('print')), [APPLY(VAR([], ATOM('add')), [INT(2), INT(2)], []), STR("'*'"), APPLY(VAR([], ATOM('mul')), [INT(2), INT(2)], []), STR("'='"), APPLY(VAR([], ATOM('mul')), [APPLY(VAR([], ATOM('add')), [INT(2), INT(2)], []), APPLY(VAR([], ATOM('mul')), [INT(2), INT(2)], [])], []), STR("'\\n'"), VAR([], ATOM('yellow')), VAR([], ATOM('submarine')), STR("'\\n'")], []), PLAIN('\n'), APPLY(VAR([], ATOM('q')), [APPLY(VAR([], ATOM('reversed')), [APPLY(VAR([], ATOM('unq')), [STR('"\\n!dlrow olleH"')], [])], [])], []), PLAIN('\n'), APPLY(LAMBDA([([], ATOM('p1'), None), ([], ATOM('p2'), None), ([], ATOM('p3'), None)], APPLY(VAR([], ATOM('add')), [APPLY(VAR([], ATOM('add')), [VAR([], ATOM('p1')), VAR([], ATOM('p2'))], []), VAR([], ATOM('p3'))], [])), [INT(1), INT(2), EMBED(LIST([INT(3), INT(4), INT(5)])), INT(6), INT(7), EMBED(LIST([INT(8), INT(9), INT(10), INT(11), INT(12), INT(13), INT(14), INT(15)]))], []), PLAIN('\n'), APPLY(VAR([], ATOM('round')), [APPLY(LAMBDA([([], ATOM('f'), None), ([], ATOM('a'), None)], APPLY(VAR([], ATOM('f')), [VAR([], ATOM('a'))], [])), [VAR([], ATOM('exp')), APPLY(VAR([], ATOM('e')), [], [])], []), INT(10)], []), PLAIN('\n'), APPLY(LAMBDA([([], ATOM('a'), None)], APPLY(LAMBDA([([], ATOM('p1'), None), ([], ATOM('p2'), None), ([], ATOM('p3'), None)], APPLY(VAR([], ATOM('add')), [APPLY(VAR([], ATOM('add')), [VAR([], ATOM('p1')), VAR([], ATOM('p2'))], []), VAR([], ATOM('p3'))], [])), [EMBED(VAR([], ATOM('a')))], [])), [LIST([INT(100), INT(10), INT(1)])], []), PLAIN('\n'), APPLY(LAMBDA([([], ATOM('a'), None), ([], ATOM('...'), None)], APPLY(APPLY(VAR([], ATOM('lazy')), [VAR([], ATOM('__va_args__'))], []), [LAMBDA([([], ATOM('f'), None)], APPLY(VAR([], ATOM('f')), [VAR([], ATOM('a'))], []))], [])), [INT(9), LAMBDA([([], ATOM('n'), None)], APPLY(VAR([], ATOM('sqrt')), [VAR([], ATOM('n'))], [])), LAMBDA([([], ATOM('n'), None)], TEXT([PLAIN(' '), APPLY(VAR([], ATOM('n')), [], []), PLAIN(' ')], 0, 0)), LAMBDA([([], ATOM('n'), None)], APPLY(VAR([], ATOM('pow')), [VAR([], ATOM('n')), INT(2)], []))], []), PLAIN('\n'), APPLY(VAR([], ATOM('join')), [LIST([TEXT([PLAIN('(1),2')], 0, 0), TEXT([PLAIN('3,(4)')], 0, 0), TEXT([PLAIN('5,6')], 0, 0), APPLY(VAR([], ATOM('zfill')), [TEXT([PLAIN('7')], 0, 0), INT(3)], [])]), TEXT([PLAIN(',')], 0, 0)], []), PLAIN('\n'), MACRO(ATOM('m'), [ATOM('c')], ' ($replace,,($c),,2,,_)'), PLAIN('\n'), APPLY(VAR([], ATOM('m')), [TEXT([PLAIN('1234256722')], 0, 0)], []), PLAIN('\n// '), STR("'12345'"), PLAIN('[ ::-1 ]\n'), APPLY(VAR([], ATOM('getslice')), [STR('12345'), STR(''), STR(''), INT(-1)], []), PLAIN('\n')], 0, 0),
...
TEXT([PLAIN('\n'), SET(ATOM('greeting'), STR('\\n!dlrow olleH')), PLAIN('\n'), APPLY(VAR([], ATOM('q')), [APPLY(VAR([], ATOM('reversed')), [APPLY(VAR([], ATOM('unq')), [VAR([], ATOM('greeting'))], [])], [])], []), PLAIN('\n'), SET(ATOM('a'), INT(222)), PLAIN('\n'), SET([ATOM('b'), ATOM('c'), ATOM('d')], APPLY(VAR([], ATOM('round')), [APPLY(VAR([], ATOM('e')), [], []), INT(11)], [])), PLAIN('\n'), SET([ATOM('e'), ATOM('f'), ATOM('g'), ATOM('h'), ATOM('i'), ATOM('j')], LIST([INT(1), INT(2), INT(3), INT(4), INT(5)])), PLAIN('\n'), APPLY(VAR([], ATOM('a')), [], []), PLAIN(' '), APPLY(VAR([], ATOM('b')), [], []), PLAIN(' '), APPLY(VAR([], ATOM('c')), [], []), PLAIN(' '), APPLY(VAR([], ATOM('d')), [], []), PLAIN(' '), APPLY(VAR([], ATOM('e')), [], []), PLAIN(' '), APPLY(VAR([], ATOM('f')), [], []), PLAIN(' '), APPLY(VAR([], ATOM('g')), [], []), PLAIN(' '), APPLY(VAR([], ATOM('h')), [], []), PLAIN(' '), APPLY(VAR([], ATOM('i')), [], []), APPLY(VAR([], ATOM('j')), [], []), PLAIN('\n'), SET(ATOM('k'), INT(10)), SET(ATOM('mult'), LAMBDA([([], ATOM('i'), None)], APPLY(VAR([], ATOM('mul')), [VAR([], ATOM('k')), VAR([], ATOM('i'))], []))), SET(ATOM('l'), INT(3)), PLAIN('\n'), APPLY(VAR([], ATOM('list')), [VAR([], ATOM('k')), APPLY(VAR([], ATOM('mult')), [INT(2)], []), APPLY(VAR([], ATOM('mult')), [VAR([], ATOM('l'))], [])], []), PLAIN('\n0\n'), COMMENT(), COMMENT(), COMMENT(), PLAIN('\n1\n'), SET(ATOM('a'), INT(1)), SET(ATOM('b'), INT(2)), PLAIN('\n2\n'), COMMENT(), PLAIN(' '), COMMENT(), PLAIN('   '), COMMENT(), PLAIN('\n3\n'), SET(ATOM('a'), INT(1)), PLAIN('  '), SET(ATOM('b'), INT(2)), PLAIN('\n4\n5'), COMMENT(), PLAIN('\n6'), SET(ATOM('a'), INT(1)), PLAIN('\n7'), COMMENT(), COMMENT(), PLAIN(' '), COMMENT(), PLAIN('\n8'), SET(ATOM('a'), INT(1)), SET(ATOM('b'), INT(2)), PLAIN(' '), SET(ATOM('c'), INT(3)), PLAIN('\n'), COMMENT(), PLAIN('9 '), COMMENT(), PLAIN('\n'), SET(ATOM('a'), INT(1)), PLAIN(' '), SET(ATOM('b'), INT(2)), PLAIN('A'), SET(ATOM('c'), INT(3)), PLAIN('\n')], 0, 0),
...
TEXT([PLAIN('\n'), APPLY(COND(INT(0), VAR([], ATOM('add')), VAR([], ATOM('sub'))), [COND(INT(1), INT(10), INT(5)), COND(INT(0), INT(0), INT(3))], []), PLAIN('\n'), SET(ATOM('if'), LAMBDA([([], ATOM('cond'), None), ([], ATOM('then'), TEXT([], 0, 0)), ([], ATOM('else'), TEXT([], 0, 0))], APPLY(COND(VAR([], ATOM('cond')), VAR([], ATOM('then')), VAR([], ATOM('else'))), [], []))), PLAIN('\n'), APPLY(VAR([], ATOM('if')), [APPLY(VAR([], ATOM('eq')), [INT(1), INT(1)], [])], [(ATOM('then'), STR("'True'")), (ATOM('else'), STR("'False'"))]), PLAIN('\n'), APPLY(VAR([], ATOM('if')), [APPLY(VAR([], ATOM('eq')), [INT(0), INT(1)], []), STR("'True'"), STR("'False'")], []), PLAIN('\n'), APPLY(VAR([], ATOM('if')), [INT(1), STR("'True'")], []), PLAIN('\n'), APPLY(VAR([], ATOM('if')), [INT(0)], [(ATOM('else'), STR("'False'"))]), PLAIN('\n'), APPLY(VAR([], ATOM('if')), [INFIX(TEXT([PLAIN(' 2 + 2 != 2 * 2 ')], 0, 0)), STR("'True'"), STR("'F'")], []), PLAIN('\n'), SET(ATOM('q'), INT(10)), PLAIN('\n'), APPLY(VAR([], ATOM('if')), [APPLY(VAR([], ATOM('eq')), [VAR([], ATOM('q')), INT(0)], []), STR("'Zero'"), VAR([], ATOM('q'))], []), PLAIN('\n'), SET(ATOM('fact'), LAMBDA([([], ATOM('n'), None)], APPLY(VAR([], ATOM('if')), [APPLY(VAR([], ATOM('eq')), [VAR([], ATOM('n')), INT(0)], []), INT(1), APPLY(VAR([], ATOM('mul')), [APPLY(VAR([], ATOM('fact')), [APPLY(VAR([], ATOM('sub')), [VAR([], ATOM('n')), INT(1)], [])], []), VAR([], ATOM('n'))], [])], []))), PLAIN('\n'), APPLY(VAR([], ATOM('fact')), [INT(0)], []), PLAIN('\n'), APPLY(VAR([], ATOM('fact')), [INT(12)], []), PLAIN('\n'), SET(ATOM('fact'), LAMBDA([([], ATOM('n'), None)], APPLY(COND(APPLY(VAR([], ATOM('eq')), [VAR([], ATOM('n')), INT(0)], []), INT(1), APPLY(VAR([], ATOM('mul')), [APPLY(VAR([], ATOM('fact')), [APPLY(VAR([], ATOM('sub')), [VAR([], ATOM('n')), INT(1)], [])], []), VAR([], ATOM('n'))], [])), [], []))), PLAIN('\n'), APPLY(VAR([], ATOM('fact')), [INT(33)], []), PLAIN(' //max is ~1200\n    '), SET(ATOM('f'), LAMBDA([([], ATOM('n'), None)], APPLY(VAR([], ATOM('if')), [APPLY(VAR([], ATOM('eq')), [VAR([], ATOM('n')), INT(0)], []), STR('"0000"'), STR('"BAD"')], []))), PLAIN('\n    '), APPLY(VAR([], ATOM('f')), [INT(0)], []), PLAIN('\n        '), APPLY(VAR([], ATOM('f')), [INT(10)], []), PLAIN('\n    '), APPLY(VAR([], ATOM('f')), [INT(0)], []), PLAIN('\n        '), APPLY(VAR([], ATOM('f')), [INT(20)], []), PLAIN('\n    // macro\n    '), MACRO(ATOM('if'), [ATOM('cond'), ATOM('then'), ATOM('else')], ' ($ ($then) ? ($cond) | ($else))'), PLAIN('\n    '), SET(ATOM('f'), LAMBDA([([], ATOM('n'), None)], APPLY(VAR([], ATOM('if')), [APPLY(VAR([], ATOM('eq')), [VAR([], ATOM('n')), INT(0)], []), STR('"0000"'), STR('"BAD"')], []))), PLAIN('\n    '), APPLY(VAR([], ATOM('f')), [INT(0)], []), PLAIN('\n        '), APPLY(VAR([], ATOM('f')), [STR('"a"')], []), PLAIN('\n    '), APPLY(VAR([], ATOM('f')), [INT(0)], []), PLAIN('\n        '), APPLY(VAR([], ATOM('f')), [INT(20)], []), PLAIN('\n'), SET(ATOM('f'), LAMBDA([([], ATOM('c'), None), ([], ATOM('a'), None), ([], ATOM('b'), None)], APPLY(APPLY(VAR([], ATOM('range')), [VAR([], ATOM('c'))], []), [LAMBDA([([], ATOM('i'), None)], APPLY(COND(VAR([], ATOM('i')), VAR([], ATOM('b')), VAR([], ATOM('a'))), [], []))], []))), PLAIN('\n'), APPLY(LAMBDA([([], ATOM('n'), None)], APPLY(VAR([], ATOM('f')), [VAR([], ATOM('n')), VAR([], ATOM('A')), VAR([], ATOM('B'))], [])), [INT(3)], []), PLAIN('\n')], 0, 0),
...
TEXT([PLAIN('\n'), SET(ATOM('fib1'), LAMBDA([([], ATOM('n'), None)], APPLY(COND(APPLY(VAR([], ATOM('lt')), [VAR([], ATOM('n')), INT(2)], []), VAR([], ATOM('n')), APPLY(VAR([], ATOM('add')), [APPLY(VAR([], ATOM('fib1')), [APPLY(VAR([], ATOM('sub')), [VAR([], ATOM('n')), INT(1)], [])], []), APPLY(VAR([], ATOM('fib1')), [APPLY(VAR([], ATOM('sub')), [VAR([], ATOM('n')), INT(2)], [])], [])], [])), [], []))), PLAIN('\n'), SET(ATOM('if'), LAMBDA([([], ATOM('cond'), None), ([], ATOM('then'), TEXT([], 0, 0)), ([], ATOM('else'), TEXT([], 0, 0))], APPLY(COND(VAR([], ATOM('cond')), VAR([], ATOM('then')), VAR([], ATOM('else'))), [], []))), PLAIN('\n'), SET(ATOM('fib'), LAMBDA([([], ATOM('n'), None)], APPLY(VAR([], ATOM('if')), [APPLY(VAR([], ATOM('lt')), [VAR([], ATOM('n')), INT(2)], []), VAR([], ATOM('n')), APPLY(VAR([], ATOM('add')), [APPLY(VAR([], ATOM('fib')), [APPLY(VAR([], ATOM('sub')), [VAR([], ATOM('n')), INT(1)], [])], []), APPLY(VAR([], ATOM('fib')), [APPLY(VAR([], ATOM('sub')), [VAR([], ATOM('n')), INT(2)], [])], [])], [])], []))), PLAIN('\n'), SET(ATOM('fib2'), LAMBDA([([], ATOM('n'), None)], APPLY(COND(INFIX(TEXT([PLAIN(' n < 2 ')], 0, 0)), VAR([], ATOM('n')), INFIX(TEXT([APPLY(VAR([], ATOM('fib2')), [INFIX(TEXT([PLAIN(' n - 1 ')], 0, 0))], []), PLAIN(' + '), APPLY(VAR([], ATOM('fib2')), [INFIX(TEXT([PLAIN(' n - 2 ')], 0, 0))], [])], 0, 0))), [], []))), PLAIN('\n'), APPLY(VAR([], ATOM('fib')), [INT(10)], []), PLAIN('\n'), APPLY(VAR([], ATOM('fib1')), [INT(10)], []), PLAIN('\n'), APPLY(INFIX(TEXT([APPLY(VAR([], ATOM('fib2')), [INT(1)], []), PLAIN(' + '), APPLY(VAR([], ATOM('fib2')), [INT(2)], []), PLAIN(' + '), APPLY(VAR([], ATOM('fib2')), [INT(3)], []), PLAIN(' - '), APPLY(VAR([], ATOM('fib2')), [INT(6)], [])], 0, 0)), [], []), PLAIN('\n'), SET([ATOM('a'), ATOM('b')], LIST([INT(5), INT(10)])), PLAIN('\n'), SET(ATOM('c'), INFIX(TEXT([PLAIN(' a + b ')], 0, 0))), PLAIN('\n'), APPLY(INFIX(TEXT([PLAIN(' int(( b + c - 2 ) * 3.5 / a )')], 0, 0)), [], []), PLAIN('\n'), SET(ATOM('f'), LAMBDA([([], ATOM('a'), None)], APPLY(INFIX(TEXT([PLAIN('a + 1')], 0, 0)), [], []))), PLAIN('\n'), SET(ATOM('g'), LAMBDA([([], ATOM('a'), None)], APPLY(VAR([], ATOM('f')), [INFIX(TEXT([PLAIN('a + 2')], 0, 0))], []))), PLAIN('\n'), SET(ATOM('h'), LAMBDA([([], ATOM('a'), None)], APPLY(VAR([], ATOM('g')), [INFIX(TEXT([PLAIN('a + 3')], 0, 0))], []))), PLAIN('\n'), APPLY(VAR([], ATOM('h')), [INT(4)], []), PLAIN('\n')], 0, 0),
...
TEXT([PLAIN('\n'), APPLY(APPLY(VAR([], ATOM('range')), [INT(3)], []), [STR('Q')], []), PLAIN('\n'), APPLY(APPLY(VAR([], ATOM('range')), [INT(10), INT(21), INT(2)], []), [LAMBDA([([], ATOM('a'), None)], APPLY(VAR([], ATOM('mul')), [VAR([], ATOM('a')), VAR([], ATOM('a'))], [])), LAMBDA([([], ATOM('a'), None)], APPLY(VAR([], ATOM('sqrt')), [VAR([], ATOM('a'))], [])), LAMBDA([([], ATOM('b'), None)], APPLY(INFIX(TEXT([STR("'\\t'"), PLAIN(' + str(b)')], 0, 0)), [], []))], []), PLAIN('\n'), SET(ATOM('R'), LIST([INT(0), INT(2), INT(4), INT(6)])), PLAIN('\n'), SET(ATOM('A'), LIST([VAR([], ATOM('zero')), INT(0), VAR([], ATOM('one')), INT(1), VAR([], ATOM('two')), INT(2), VAR([], ATOM('three')), INT(3)])), PLAIN('\n'), SET(ATOM('F'), LAMBDA([([], ATOM('p'), None)], APPLY(VAR([], ATOM('p')), [EMBED(VAR([], ATOM('A')))], []))), PLAIN('\n'), SET(ATOM('S'), LAMBDA([([], ATOM('p'), None)], APPLY(VAR([], ATOM('mod')), [STR('"%s "'), VAR([], ATOM('p'))], []))), PLAIN('\n'), SET(ATOM('LOOP'), LAMBDA([([], ATOM('r'), None), ([], ATOM('b'), None)], APPLY(APPLY(VAR([], ATOM('range')), [EMBED(VAR([], ATOM('r')))], []), [VAR([], ATOM('b'))], []))), PLAIN('\n'), SET(ATOM('R1'), LIST([INT(0), INT(7), INT(2)])), PLAIN('\n'), SET(ATOM('FL'), LIST([VAR([], ATOM('F')), VAR([], ATOM('S'))])), PLAIN('\n'), APPLY(COND(INFIX(TEXT([APPLY(VAR([], ATOM('R')), [VAR([], ATOM('F')), VAR([], ATOM('S'))], []), PLAIN(' == '), APPLY(VAR([], ATOM('LOOP')), [VAR([], ATOM('R1')), EMBED(VAR([], ATOM('FL')))], [])], 0, 0)), APPLY(VAR([], ATOM('LOOP')), [VAR([], ATOM('R1')), EMBED(VAR([], ATOM('FL')))], []), TEXT([PLAIN('ERROR '), APPLY(VAR([], ATOM('LOOP')), [VAR([], ATOM('R1')), EMBED(VAR([], ATOM('FL')))], []), PLAIN(' != '), APPLY(VAR([], ATOM('R')), [VAR([], ATOM('F')), VAR([], ATOM('S'))], [])], 0, 0)), [], []), PLAIN('\n'), APPLY(VAR([], ATOM('LOOP')), [LIST([INT(0), INT(100), INT(10)]), LAMBDA([([], ATOM('o'), None)], APPLY(VAR([], ATOM('o')), [], []))], []), PLAIN('\n'), SET(ATOM('R'), LIST([LIST([INT(0), VAR([], ATOM('a'))]), LIST([INT(1), VAR([], ATOM('bb'))]), LIST([INT(2), VAR([], ATOM('ccc'))]), LIST([INT(3), VAR([], ATOM('dddd'))])])), PLAIN('\n'), APPLY(VAR([], ATOM('R')), [LAMBDA([([], ATOM('l'), None)], APPLY(LAMBDA([([], ATOM('n'), None), ([], ATOM('id'), None)], TEXT([PLAIN(' '), APPLY(VAR([], ATOM('id')), [], []), PLAIN(' = '), APPLY(INFIX(TEXT([PLAIN('n * 11')], 0, 0)), [], []), PLAIN(';')], 0, 0)), [EMBED(VAR([], ATOM('l')))], []))], []), PLAIN('\n'), SET(ATOM('L'), LIST([INT(0), INT(90), INT(180)])), PLAIN('\n'), SET(ATOM('R'), APPLY(APPLY(VAR([], ATOM('L')), [VAR([], ATOM('cos'))], []), [LAMBDA([([], ATOM('f'), None)], APPLY(VAR([], ATOM('round')), [VAR([], ATOM('f')), INT(12)], []))], [])), PLAIN('\n'), APPLY(INFIX(TEXT([PLAIN(' '), STR("'%f %f %f'"), PLAIN(' % tuple(R) ')], 0, 0)), [], []), PLAIN('\n'), SET(ATOM('L1'), APPLY(VAR([], ATOM('LOOP')), [APPLY(VAR([], ATOM('len')), [VAR([], ATOM('L'))], []), LAMBDA([([], ATOM('i'), None)], APPLY(VAR([], ATOM('unq')), [APPLY(VAR([], ATOM('mod')), [STR("'($%d)'"), VAR([], ATOM('i'))], [])], []))], [])), PLAIN('\n'), APPLY(INFIX(TEXT([PLAIN(' '), STR("' '"), PLAIN('.join(L1) ')], 0, 0)), [EMBED(APPLY(VAR([], ATOM('R')), [], []))], []), PLAIN('\n'), APPLY(LIST([INT(1), INT(2), INT(3)]), [], []), PLAIN('\n{\n    '), APPLY(APPLY(VAR([], ATOM('range')), [INT(3)], []), [LAMBDA([([], ATOM('i'), None)], TEXT([PLAIN('        '), SET(ATOM('fn'), LAMBDA([([], ATOM('ii'), None)], APPLY(VAR([], ATOM('ii')), [], []))), APPLY(APPLY(VAR([], ATOM('range')), [APPLY(VAR([], ATOM('add')), [VAR([], ATOM('i')), INT(2)], [])], []), [VAR([], ATOM('fn'))], []), PLAIN(',\n')], 0, 0))], []), PLAIN('\n}\n'), SET(ATOM('fn'), LIST([STR("'($\\\\i.($add i 1))'"), STR("'($\\\\i.($i))'"), STR("'($\\\\i.($sub i 1))'")])), PLAIN('\n'), SET(ATOM('each'), APPLY(VAR([], ATOM('range')), [APPLY(VAR([], ATOM('len')), [VAR([], ATOM('fn'))], [])], [])), PLAIN('\n'), APPLY(VAR([], ATOM('each')), [LAMBDA([([], ATOM('i'), None)], TEXT([PLAIN(' '), APPLY(EVAL(APPLY(APPLY(VAR([], ATOM('i')), [VAR([], ATOM('fn'))], []), [], [])), [INT(10)], []), PLAIN(';')], 0, 0))], []), PLAIN('\n'), SET(ATOM('a'), LIST([LIST([INT(1), INT(2), INT(3), INT(4), INT(5)]), LIST([INT(6), INT(7), INT(8), INT(9), INT(0)]), LIST([VAR([], ATOM('z')), VAR([], ATOM('w')), VAR([], ATOM('r')), VAR([], ATOM('t')), VAR([], ATOM('y'))]), LIST([VAR([], ATOM('u')), VAR([], ATOM('i')), VAR([], ATOM('o')), VAR([], ATOM('p')), VAR([], ATOM('s'))]), LIST([VAR([], ATOM('d')), VAR([], ATOM('f')), VAR([], ATOM('g')), VAR([], ATOM('h')), VAR([], ATOM('j'))])])), PLAIN('\n'), APPLY(VAR([], ATOM('a')), [LAMBDA([([], ATOM('aa'), None)], APPLY(VAR([], ATOM('aa')), [LAMBDA([([], ATOM('aaa'), None)], TEXT([PLAIN(' {'), APPLY(VAR([], ATOM('aaa')), [], []), PLAIN('}')], 0, 0))], []))], []), PLAIN('\n'), APPLY(LIST([INT(0), INT(1), INT(2)]), [LAMBDA([([], ATOM('i'), None)], APPLY(LIST([INT(2), INT(3), INT(4)]), [LAMBDA([([], ATOM('ii'), None)], TEXT([PLAIN(' {'), APPLY(VAR([], ATOM('i')), [APPLY(VAR([], ATOM('ii')), [VAR([], ATOM('a'))], [])], []), PLAIN('} ('), APPLY(VAR([], ATOM('ii')), [APPLY(VAR([], ATOM('i')), [VAR([], ATOM('a'))], [])], []), PLAIN(')')], 0, 0))], []))], []), PLAIN('\n'), MACRO(ATOM('_set'), [ATOM('name'), ATOM('val')], '($set ($name) ($val))'), PLAIN('\n'), APPLY(VAR([], ATOM('_set')), [VAR([], ATOM('five')), INT(5)], []), PLAIN('\n'), APPLY(VAR([], ATOM('mul')), [VAR([], ATOM('five')), VAR([], ATOM('five'))], []), PLAIN('\n'), APPLY(LIST([VAR([], ATOM('add')), VAR([], ATOM('sub')), VAR([], ATOM('mul')), VAR([], ATOM('div'))]), [LAMBDA([([], ATOM('fn'), None)], APPLY(VAR([], ATOM('fn')), [INT(8), INT(2)], []))], []), PLAIN('\n'), SET(ATOM('q'), INT(3)), PLAIN('\n'), MACRO(ATOM('a'), [ATOM('n')], ' ($emit q \\d.($add d ($n)) )'), PLAIN('\n{\n    '), EMIT(VAR([], ATOM('q')), VAR([], ATOM('inc'))), PLAIN(', '), APPLY(APPLY(VAR([], ATOM('range')), [INT(4)], []), [LAMBDA([([], ATOM('n'), None)], TEXT([APPLY(VAR([], ATOM('a')), [VAR([], ATOM('n'))], []), PLAIN(', ')], 0, 0))], []), APPLY(VAR([], ATOM('q')), [], []), PLAIN(',\n}\n')], 0, 0),
