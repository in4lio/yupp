"""
Browsing the source code of files generated by yupp C preprocessor
Copyright (c) 2015 Vitaly Kravtsov (in4lio@gmail.com)
        ...
        if state == STATE_NO_BROWSE:
            ...
            if fn in file_jump:
                if pos in file_jump[ fn ]:
                    ...
                    # jump to source or back to fruit
